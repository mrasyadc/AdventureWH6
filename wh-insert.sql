...
-- Employee
insert into AdventureWH6.WH.Employee (BusinessEntityID, SalesQuota, SalesYTD, CommissionPct, PayRate, PayFrequency, SickLeaveHours, VacationHours, ShiftKey, DepartmentKey, BirthDate, HireDate, FirstName, MiddleName, LastName, GenderKey, MaritalKey, TitleKey)
select E.BusinessEntityID, SalesQuota, SalesYTD, CommissionPct, Rate, PayFrequency, SickLeaveHours, VacationHours, ShiftKey, DepartmentKey, BirthDate, HireDate, FirstName, MiddleName, LastName, GenderKey, MaritalKey, TitleKey from AdventureWorks2019.HumanResources.Employee E
